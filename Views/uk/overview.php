...
<a class="btn btn-primary mb-2 py-2" href="<?=base_url()?>/uk/create">Create Article</a><br /><br /> 
	...
	<?php foreach ($uk as $news_item): ?>
		...
		<div class="card mb-2 h-100">
			...
			<div class="card-footer">
				<div class ="btn-group">
					<a href="<?=base_url()?>/uk/<?= esc($news_item['slug'], 'url') ?>" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
					...
					<a href="<?=base_url()?>/uk/delete/<?= esc($news_item['slug'], 'url') ?>" class=" btn btn-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
