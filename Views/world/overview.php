	...
	<?php foreach ($world as $news_item): ?>
		...
		<div class="card mb-2 h-100">
			...
			<div class="card-footer">
				<div class="btn-group">
					<a href="<?=base_url()?>/world/<?= esc($news_item['slug'], 'url') ?>" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
					...
					<a href="<?=base_url()?>/world/delete/<?= esc($news_item['slug'], 'url') ?>" class=" btn btn-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
...
<script>
	function getData(slug) {
		...
		// fetch data
		fetch('https://mi-linux.wlv.ac.uk/~1827197/project-root/public/worldajax/get/' + slug)
